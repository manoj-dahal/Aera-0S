...
exports.MultilingualUnderstanding = void 0;
const GroqAdapter_1 = require("../../api/groq/GroqAdapter");
class MultilingualUnderstanding {
    llmAdapter;
    constructor() {
        this.llmAdapter = new GroqAdapter_1.GroqAdapter();
    }
    /**
     ...
     */
    async detectAndNormalizeMixedLanguage(rawInput) {
...
exports.MultilingualUnderstanding = MultilingualUnderstanding;
